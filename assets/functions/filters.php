...
/**
 * Adds "active" class to menu items with "current_page_item" for bootstrap
 * @since  1.0
 * @return string "active" class on menu item
 */
...
add_filter('nav_menu_css_class', 'rwbs_add_active_class_to_nav_menu');
